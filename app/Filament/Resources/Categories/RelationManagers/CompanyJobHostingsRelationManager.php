...
class CompanyJobHostingsRelationManager extends RelationManager
{
  protected static string $relationship = 'companyJobHostings';
  protected static ?string $title = 'عروض وظائف الشركات التابعة لهذا التصنيف';

  public function table(Table $table): Table
  {
    return $table
      ->recordTitleAttribute('title')
      ->defaultSort('company_job_hostings.created_at', 'desc')
      ->columns([
