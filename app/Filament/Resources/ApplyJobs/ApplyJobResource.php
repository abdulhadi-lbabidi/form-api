...
use App\Filament\Resources\ApplyJobs\Pages\ViewApplyJob;
use App\Filament\Resources\ApplyJobs\Schemas\ApplyJobForm;
use App\Filament\Resources\ApplyJobs\Schemas\ApplyJobInfolist;
...
class ApplyJobResource extends Resource
{
  ...
  protected static ?string $pluralModelLabel = 'الطلبات المقدمة';
  protected static ?string $recordTitleAttribute = 'ApplyJob';
  ...
  {
    return ApplyJobInfolist::configure($schema);
  }
  ...
  public static function getPages(): array
  {
    return [
      ...
      'view' => ViewApplyJob::route('/{record}'),
